...
public class QuizController {
    ...
    public ResponseEntity<Void> createQuiz(@PathVariable UUID userId, @Valid @RequestBody CreateQuizRequestDTO createQuizRequestDTO) {
    ...
    public ResponseEntity<QuizResponseDTO> getSingleQuiz(@PathVariable UUID userId, @PathVariable UUID quizId) {
        userService.userWithIDExists(userId);
        return ResponseEntity.status(HttpStatus.OK).body(quizService.getQuiz(userId, quizId));
    }
}
